...
export default function App() {
    ...
    const modelIn = useGLTF('./OLSK_Large_CNC_V2_IN.glb') //Substitute the file name here for ALL IN
    const modelOut = useGLTF('./OLSK_Large_CNC_V2_OUT.glb') //Substitute the file name here for ALL OUT
    ...
    useGLTF.clear('./OLSK_Large_CNC_V2_IN.glb')  //Substitute the file name here for ALL IN
    useGLTF.clear('./OLSK_Large_CNC_V2_OUT.glb') //Substitute the file name here for ALL OUT
...
useGLTF.preload('./OLSK_Large_CNC_V2_IN.glb') //Substitute the file name here for ALL IN
useGLTF.preload('./OLSK_Large_CNC_V2_OUT.glb') //Substitute the file name here for ALL OUT
