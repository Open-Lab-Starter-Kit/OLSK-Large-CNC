...
export default function Model({ modelIn, modelOut, modelInCopy, modelInCopy2, modelOutCopy }) {
    ...
    const preparingStepArray = [ //shown grouped
        [
            "021_Prepare_Y_linear_guide_beams_1",
            "022_Prepare_Y_linear_guide_beam_2"
        ],
        [
            "051_Prepare_base_front_and_back_bottom_beams",
            "052_Fix_base_front_and_back_top_beams",
            "053_Fix_brackets"
        ],
        [

            "07_Prepare_Y_ball_screws",
            "08_Add_shoulders'_front_plate_and_motor",
            "09_Insert_shoulders'_back_plate",
            "10_Assemble_Shoulders",
            "11_Fix_shoulder_attacher_plate"
        ],
        [
            "13_Fix_front_corner_linear_guides"
        ],
        [
            "18_Prepare_X_main_plate"
        ],
        [
            "191_Prepare_X_ball_screw_1",
            "192_Prepare_X_ball_screw_2",
            "193_Prepare_X_ball_screw_3",
            "20_Attach_X_ball_screw_on_X_main_plate",
            "21_Fix_X_front_plate",
            "22_Fix_X_beam",
            "23_Attach_X_motor"
        ],
        [
        ...
        [
            ...
            "28_Prepare_Z_middle_plate"
        ],
        [
            "31_Prepare_Z_motor_holder"
        ],
        [
            "35_Prepare_head_bottom_attachment"
        ],
        [
            "461_Prepare_side_middle_vertical_beam"
        ],
        [
            "481_Prepare_roof_middle_long_beam_1",
            "482_Prepare_roof_middle_long_beam_2",
            "483_Prepare_roof_middle_long_beam_3"
        ],
        [
            "531_Prepare_Inner_back_panel_-_electronic_panel",
            "532_Prepare_Inner_back_panel_-_pneumatic_panel"
        ],
        [
            "561_Prepare_tool_holder_supports",
            "562_Prepare_bed_back_plate"
        ],
        [
            "591_Prepare_front_window_frame",
            "592_Attach_frame_to_window",
            "593_Fix_handle",
            "594_Fix_front_window_electronics"
        ],
        [
            "641_Prepare_right_window",
            "642_Fix_top_piston_supports",
            "643_Attach_right_window_frame"
        ],
        [
            "651_Prepare_left_window",
            "652_Fix_top_piston_supports",
            "653_Attach_left_window_frame"
        ],
        [
            "72_Prepare_back_doors"
        ]
    ]
    const wiringStepArray = [ //add schematic,
        "61_Front_window_wiring",
        "67_Prepare_power_switch",
        "691_Wiring_AC_1",
        "692_Wiring_AC_2",
        "693_Wiring_AC_3",
        "694_Wiring_AC_4",
        ...
        "703_Wiring_DC_3",
        "704_Wiring_DC_4",
        "716_Install_pneumatics_-_tubes"
    ]
